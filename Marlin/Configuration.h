...
#define STRING_CONFIG_H_AUTHOR "(Jon Young 9-11-2020 SKR 1.4 Turbo)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 218.60
  #define DEFAULT_bedKi 36.52
  #define DEFAULT_bedKd 872.34
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 99.8, 99.8, 398.6, 405 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 57, -7.5, -3.55 } //{ 57.6, -10.6, -3.15 }
...
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points (4)
